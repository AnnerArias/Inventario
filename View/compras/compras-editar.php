...
<div class="contenedor"> 
        <ul class="miga-de-pan">
            <li><a href="http://localhost/Sistemainventario/dashboard">Inicio</a></li>
            <li><a href="http://localhost/Sistemainventario/producto">Productos</a></li>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <?php
                        ...
                        echo'<option value="'.$cate->nombre.'">Actual: '.$cate->nombre.'</option>';
