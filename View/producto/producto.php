...
<div class="miga-de-pan">
    <a href="?c=dashboard">Inicio</a> / <span>Lista de Productos</span>
</div>
<div class="contenido">
    <!-- contenido desde aqui -->

    <div class="contenedor-3d">
        <a type="submit" href="?c=producto&a=Nuevo" class="btn" style="margin-bottom: 30px;"><button class="boton-crear"><i class="fas fa-plus"></i></button></a>
        <div class="division">
            <!-- contenido -->
                ...
                <tbody>
                    ...
                    foreach ($this->model->Listar() as $r): ?>
                        <tr>
                            ...
                            <td><img src="assets/img/productos/<?php echo $r->imagen; ?>" alt="" class="img-tabla"></td>
